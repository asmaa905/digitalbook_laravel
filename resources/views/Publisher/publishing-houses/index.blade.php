...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('publisher.publishing-houses.create') }}" class="btn btn-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('publisher.publishing-houses.edit', $house->id) }}" class="btn btn-sm btn-warning">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('publisher.publishing-houses.destroy', $house->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
