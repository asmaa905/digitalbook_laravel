...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ isset($publishingHouse) ? route('publisher.publishing-houses.update', $publishingHouse->id) : route('publisher.publishing-houses.store') }}" enctype="multipart/form-data">
            @csrf
